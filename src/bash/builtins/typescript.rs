...
///
/// ```ignore
/// use crate::bash::TypeScriptLimits;
/// use std::time::Duration;
///
...
/// Configure via [`BashBuilder::typescript_with_external_handler`](crate::bash::BashBuilder::typescript_with_external_handler).
#[derive(Clone)]
...
///
/// ```ignore
/// use crate::bash::{TypeScriptConfig, TypeScriptLimits};
/// use std::time::Duration;
///
...
///
/// ```ignore
/// use crate::bash::{Bash, TypeScriptConfig};
///
/// # fn main() {
...
mod tests {
    use super::*;
    use crate::bash::builtins::Context;
