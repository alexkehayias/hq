//! File inspection builtins - file, stat
...
fn format_stat(name: &str, metadata: &crate::bash::fs::Metadata, format: &str) -> String {
...
fn format_permissions(metadata: &crate::bash::fs::Metadata) -> String {
...
/// Default stat format
fn default_stat_format(name: &str, metadata: &crate::bash::fs::Metadata) -> String {
