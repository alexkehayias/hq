...
/// `crate::bash::builtins::clap_env::apply_env_defaults` so bashkit's
/// virtual `ctx.env` — never `std::env` — drives clap's env-default
/// path. Order matches the chain order in the original `uu_app()`.
pub static LS_ENV_DEFAULTS: &[crate::bash::builtins::clap_env::EnvDefault] = &[
    crate::bash::builtins::clap_env::EnvDefault {
        arg_id: options::TIME_STYLE,
        long: options::TIME_STYLE,
        env_var: "TIME_STYLE",
        kind: crate::bash::builtins::clap_env::EnvKind::Single,
    },
    crate::bash::builtins::clap_env::EnvDefault {
