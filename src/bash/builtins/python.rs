...
use crate::bash::fs::{FileSystem, FileType};
...
/// Configure via [`BashBuilder::python_with_external_handler`](crate::bash::BashBuilder::python_with_external_handler).
#[derive(Clone)]
