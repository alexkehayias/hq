...
use crate::bash::builtins::clap_env::apply_env_defaults;
use crate::bash::builtins::generated::ls_args::{LS_ENV_DEFAULTS, ls_command};
use crate::bash::builtins::{Builtin, Context, resolve_path};
...
impl Builtin for Ls {
    async fn execute(&self, ctx: Context<'_>) -> Result<ExecResult> {
        ...
        let mut file_args: Vec<(&str, crate::bash::fs::Metadata)> = Vec::new();
...
pub(super) fn classify_suffix(metadata: &crate::bash::fs::Metadata) -> &'static str {
