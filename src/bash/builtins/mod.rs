...
//!
//! ```ignore//! use crate::bash::{Builtin, BuiltinContext, ExecResult, async_trait};
//!
//! struct MyCommand;
//!
//! #[async_trait]
...
//! ```
//!
//! Register via [`BashBuilder::builtin`](crate::bash::BashBuilder::builtin).
...
pub(crate) use crate::bash::interpreter::ShellRef;

// Re-export for use by builtins
pub use crate::bash::interpreter::BuiltinSideEffect;
...
pub trait Extension: Send + Sync {
    ...
    /// matching [`BashBuilder::builtin`](crate::bash::BashBuilder::builtin).
    fn builtins(&self) -> Vec<(String, Box<dyn Builtin>)>;
}

/// Host-owned, mutable registry of builtin commands.
///
/// Unlike [`BashBuilder::builtin`](crate::bash::BashBuilder::builtin), entries can be
...
use crate::bash::fs::normalize_path;
...
///
/// ```ignore
/// use crate::bash::{Builtin, BuiltinContext, ExecResult, async_trait};
///
/// struct Echo;
///
/// #[async_trait]
...
pub struct Context<'a> {
    ...
    ///
    /// Read-only access to variables set via [`BashBuilder::env`](crate::bash::BashBuilder::env)
    ...
    /// [`BashBuilder::network`](crate::bash::BashBuilder::network).
    ...
    /// [`BashBuilder::git`](crate::bash::BashBuilder::git).
    #[cfg(feature = "git")]
    pub git_client: Option<&'a crate::bash::builtins::git::GitClient>,
    ...
    /// [`BashBuilder::ssh`](crate::bash::BashBuilder::ssh).
    #[cfg(feature = "ssh")]
    pub ssh_client: Option<&'a crate::bash::builtins::ssh::SshClient>,
...
impl<'a> Context<'a> {
    ...
    pub fn new_for_test(
        ...
        fs: std::sync::Arc<dyn crate::bash::fs::FileSystem>,
        stdin: Option<&'a str>,
    ) -> Self {
        Self {
            args,
...
///
/// ```ignore
/// use crate::bash::{Bash, Builtin, BuiltinContext, ExecResult, async_trait};
///
/// struct Greet {
///     default_name: String,
/// }
...
pub trait Builtin: Send + Sync {
    ...
    /// session caches must override this so [`Bash::restore_snapshot`](crate::bash::Bash::restore_snapshot)
...
///
/// ```ignore
/// use crate::bash::{Bash, BashkitContext, ClapBuiltin, async_trait};
/// use crate::bash::clap::Parser;
///
/// #[derive(Parser)]
/// #[command(name = "greet")]
/// struct GreetArgs {
...
/// Internal alias for `crate::bash::testing` so per-tool `#[cfg(test)]`
/// modules can keep their existing `crate::bash::builtins::debug_leak_check::*`
/// imports. The source of truth is `crate::bash::testing` (which is also
/// reachable from integration tests and cargo-fuzz targets).
#[cfg(test)]
pub(crate) use crate::bash::testing as debug_leak_check;
...
mod tests {
    ...
    //
    // Static guard — walks every `crates/bashkit/src/bash/builtins/*.rs` file
    ...
    fn no_debug_fmt_in_builtin_source() {
        ...
        let dir = std::path::Path::new(env!("CARGO_MANIFEST_DIR")).join("src/bash/builtins");
    ...
    fn ls_env_defaults_surface_matches_uutils() {
        use crate::bash::builtins::generated::ls_args::LS_ENV_DEFAULTS;
