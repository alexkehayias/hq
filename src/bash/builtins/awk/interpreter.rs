...
use crate::bash::builtins::MAX_FORMAT_WIDTH;
...
use crate::bash::builtins::search_common::build_regex;
use crate::bash::fs::{FileSystem, normalize_path};
use crate::bash::limits::ExecutionLimits;
...
struct WriteJob {
    ...
    bytes: Vec<u8>,
    append: bool,
    resp: std::sync::mpsc::Sender<crate::bash::error::Result<()>>,
}
...
impl VfsWriter {
    ...
    fn write(
        ...
        bytes: Vec<u8>,
        append: bool,
    ) -> Result<crate::bash::error::Result<()>, ()> {
