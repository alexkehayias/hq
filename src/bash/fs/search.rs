...
//!
//! ```ignore//! use crate::bash::{SearchCapable, SearchProvider, SearchQuery, SearchResults,
//!     SearchCapabilities, SearchMatch};
//! use crate::bash::{async_trait, FileSystem, FileSystemExt, InMemoryFs, Result};
...
mod tests {
    use super::*;
    use crate::bash::fs::{FileSystem, FileSystemExt, InMemoryFs};
