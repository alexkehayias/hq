...
pub mod fs_errors {
    ...
    #[inline]
    pub fn is_a_directory() -> crate::bash::error::Error {
    ...
    #[inline]
    pub fn already_exists(msg: &str) -> crate::bash::error::Error {
    ...
    #[inline]
    pub fn not_a_directory() -> crate::bash::error::Error {
        IoError::other("not a directory").into()
    }

    /// Error for non-empty directory removal without recursive flag.
    #[inline]
    pub fn directory_not_empty() -> crate::bash::error::Error {
...
///
/// ```ignore
/// use crate::bash::{async_trait, FileSystem, FileSystemExt, Result};
///
...
///
/// Pass your filesystem to [`Bash::builder()`](crate::bash::Bash::builder):
///
/// ```ignore
/// use crate::bash::Bash;
/// use std::sync::Arc;
...
///
/// ```ignore
/// use crate::bash::{Bash, FileSystem, FileType};
/// use std::path::Path;
///
/// # #[tokio::main]
...
impl FileType {
    ...
    /// # Example
    ///
    /// ```ignore    /// use crate::bash::FileType;
    ///
...
///
/// ```ignore
/// use crate::bash::{Bash, FileSystem};
/// use std::path::Path;
///
/// # #[tokio::main]
/// # async fn main() -> bashkit::Result<()> {
...
mod tests {
    ...
    fn filesystem_default_usage_returns_zeros() {
        ...
        impl FileSystem for Dummy {
            async fn read_file(&self, _: &Path) -> crate::bash::error::Result<Vec<u8>> {
                unimplemented!()
            }
            async fn write_file(&self, _: &Path, _: &[u8]) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn append_file(&self, _: &Path, _: &[u8]) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn mkdir(&self, _: &Path, _: bool) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn remove(&self, _: &Path, _: bool) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn stat(&self, _: &Path) -> crate::bash::error::Result<Metadata> {
                unimplemented!()
            }
            async fn read_dir(&self, _: &Path) -> crate::bash::error::Result<Vec<DirEntry>> {
                unimplemented!()
            }
            async fn exists(&self, _: &Path) -> crate::bash::error::Result<bool> {
                unimplemented!()
            }
            async fn rename(&self, _: &Path, _: &Path) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn copy(&self, _: &Path, _: &Path) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn symlink(&self, _: &Path, _: &Path) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
            async fn read_link(&self, _: &Path) -> crate::bash::error::Result<std::path::PathBuf> {
                unimplemented!()
            }
            async fn chmod(&self, _: &Path, _: u32) -> crate::bash::error::Result<()> {
                unimplemented!()
            }
        }
