...
///
/// ```ignore
/// use crate::bash::{Bash, FileSystem, InMemoryFs, MountableFs};
/// use std::path::Path;
/// use std::sync::Arc;
///
/// # #[tokio::main]
...
///
/// ```ignore
/// use crate::bash::{FileSystem, InMemoryFs, MountableFs};
/// use std::path::Path;
/// use std::sync::Arc;
///
/// # #[tokio::main]
...
impl MountableFs {
    ...
    /// # Example
    ///
    /// ```ignore    /// use crate::bash::{FileSystem, InMemoryFs, MountableFs};
    /// use std::path::Path;
    /// use std::sync::Arc;
    ///
    /// # #[tokio::main]
