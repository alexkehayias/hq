...
///
/// ```ignore
/// use crate::bash::{Bash, FileSystem, InMemoryFs, OverlayFs};
/// use std::path::Path;
/// use std::sync::Arc;
///
/// # #[tokio::main]
...
///
/// ```ignore
/// use crate::bash::{FileSystem, InMemoryFs, OverlayFs};
/// use std::path::Path;
/// use std::sync::Arc;
///
/// # #[tokio::main]
...
impl OverlayFs {
    ...
    /// # Example
    ///
    /// ```ignore    /// use crate::bash::{FileSystem, InMemoryFs, OverlayFs};
    /// use std::path::Path;
    /// use std::sync::Arc;
    ///
    /// # #[tokio::main]
    ...
    /// # Example
    ///
    /// ```ignore    /// use crate::bash::{FileSystem, InMemoryFs, OverlayFs, FsLimits};
    /// use std::path::Path;
    /// use std::sync::Arc;
    ///
    /// # #[tokio::main]
    ...
    /// # Example
    ///
    /// ```ignore    /// use crate::bash::{InMemoryFs, OverlayFs};
    /// use std::sync::Arc;
    ///
    /// let base = Arc::new(InMemoryFs::new());
    /// let overlay = OverlayFs::new(base);
...
impl FileSystemExt for OverlayFs {
    ...
    fn vfs_restore(&self, snapshot: &super::VfsSnapshot) -> crate::bash::error::Result<()> {
