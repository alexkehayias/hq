...
//!
//! ```ignore
//! use crate::bash::{async_trait, FsBackend, PosixFs, Bash, Result, Metadata, DirEntry};
//! use std::sync::Arc;
//!
...
//!
//! ```ignore
//! use crate::bash::{async_trait, FileSystem, FileSystemExt, Bash};
//!
//! struct MyFs { /* ... */ }
//!
//! #[async_trait]
...
//!
//! [`InMemoryFs`] is the default filesystem when using [`Bash::new()`](crate::bash::Bash::new):
//!
//! ```ignore//! use crate::bash::Bash;
//!
//! # #[tokio::main]
...
//!
//! ```ignore//! use crate::bash::{Bash, FileSystem, InMemoryFs, OverlayFs};
//! use std::path::Path;
//! use std::sync::Arc;
//!
//! # #[tokio::main]
...
//!
//! ```ignore//! use crate::bash::{Bash, FileSystem, InMemoryFs, MountableFs};
//! use std::path::Path;
//! use std::sync::Arc;
//!
//! # #[tokio::main]
...
//!
//! ```ignore//! use crate::bash::{Bash, FileSystem};
//! use std::path::Path;
//!
//! # #[tokio::main]
//! # async fn main() -> bashkit::Result<()> {
...
//!
//! ```ignore//! use crate::bash::{async_trait, FileSystem, FileSystemExt, DirEntry, Metadata, FileType, Result, Error};
...
//!
//! ```ignore//! use crate::bash::{verify_filesystem_requirements, InMemoryFs};
//! use std::sync::Arc;
//!
//! # #[tokio::main]
//! # async fn main() -> bashkit::Result<()> {
...
fn disabled_fs_error() -> crate::bash::error::Error {
...
///
/// ```ignore
/// use crate::bash::{verify_filesystem_requirements, InMemoryFs};
/// use std::sync::Arc;
///
/// # #[tokio::main]
/// # async fn main() -> bashkit::Result<()> {
