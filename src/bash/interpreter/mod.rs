...
use crate::bash::builtins::{self, Builtin};
#[cfg(feature = "failpoints")]
use crate::bash::error::Error;
use crate::bash::error::Result;
use crate::bash::fs::FileSystem;
use crate::bash::limits::{ExecutionCounters, ExecutionLimits, SessionLimits};
...
pub(crate) struct ShellRef<'a> {
    ...
    pub(crate) host_builtins: Option<&'a crate::bash::builtins::BuiltinRegistry>,
...
fn merged_builtin_names(
    ...
    host_builtins: Option<&crate::bash::builtins::BuiltinRegistry>,
) -> Vec<String> {
...
impl ShellRef<'_> {
    ...
    /// registry) — same contract as [`crate::bash::Bash::builtin_names`].
...
struct SubshellSnapshot {
    ...
    flags: BashFlags,
    cwd: PathBuf,
    memory_budget: crate::bash::limits::MemoryBudget,
...
pub struct Interpreter {
    ...
    memory_limits: crate::bash::limits::MemoryLimits,
    /// Memory budget tracker
    memory_budget: crate::bash::limits::MemoryBudget,
    /// Trace event collector
    trace: crate::bash::trace::TraceCollector,
    ...
    http_client: Option<crate::bash::network::HttpClient>,
    /// Git client for git builtins
    #[cfg(feature = "git")]
    git_client: Option<crate::bash::builtins::git::GitClient>,
    /// SSH client for ssh/scp/sftp builtins
    #[cfg(feature = "ssh")]
    ssh_client: Option<crate::bash::builtins::ssh::SshClient>,
...
impl Interpreter {
    ...
    pub fn with_config(
        ...
        Self {
            ...
            memory_limits: crate::bash::limits::MemoryLimits::default(),
            memory_budget: crate::bash::limits::MemoryBudget::default(),
            trace: crate::bash::trace::TraceCollector::default(),
            ...
            hooks: crate::bash::hooks::Hooks::default(),
            in_trap: false,
    ...
    pub fn hooks(&self) -> &crate::bash::hooks::Hooks {
        &self.hooks
    }
    ...
    pub(crate) fn set_hooks(&mut self, hooks: crate::bash::hooks::Hooks) {
        self.hooks = hooks;
    }
    ...
    fn check_cancelled(&self) -> Result<()> {
        if self.cancelled.load(Ordering::Relaxed) {
            Err(crate::bash::error::Error::Cancelled)
        } else {
            Ok(())
        }
    }
    ...
    pub(crate) fn begin_exec_invocation(&mut self) -> Result<()> {
        ...
        self.counters
            ...
            .map_err(|e| crate::bash::error::Error::Execution(e.to_string()))
    }

    /// Set per-instance memory limits.
    pub fn set_memory_limits(&mut self, limits: crate::bash::limits::MemoryLimits) {
        self.memory_limits = limits;
    }

    /// Set the trace collector.
    pub fn set_trace(&mut self, trace: crate::bash::trace::TraceCollector) {
        self.trace = trace;
    }
    ...
    pub fn restore_shell_state(&mut self, state: &ShellState) {
        ...
        let mut function_memory_budget = crate::bash::limits::MemoryBudget::default();
        ...
        let func_bytes: usize = self
            ...
            .sum();
        self.memory_budget = crate::bash::limits::MemoryBudget::recompute_from_state(
    ...
    pub(crate) fn validate_shell_state_restore_limits(&self, state: &ShellState) -> Result<()> {
        ...
        if state.dir_stack.len() > crate::bash::builtins::limits::DIRSTACK_MAX_SIZE {
            return Err(crate::bash::limits::LimitExceeded::Memory(format!(
                "directory stack entry limit ({}) exceeded",
                crate::bash::builtins::limits::DIRSTACK_MAX_SIZE
            ))
            .into());
        }
        for dir in &state.dir_stack {
            if dir.len() > crate::bash::builtins::limits::DIRSTACK_MAX_ENTRY_BYTES {
                return Err(crate::bash::limits::LimitExceeded::Memory(format!(
                    "directory stack entry byte limit ({}) exceeded",
                    crate::bash::builtins::limits::DIRSTACK_MAX_ENTRY_BYTES
                ))
                .into());
            }
            if dir.contains('\0') {
                return Err(crate::bash::limits::LimitExceeded::Memory(
        ...
        let mut budget = crate::bash::limits::MemoryBudget::recompute_from_state(
            &state.variables,
            &state.arrays,
            &state.assoc_arrays,
            0,
    ...
    pub fn counters(&self) -> &crate::bash::limits::ExecutionCounters {
        &self.counters
    }
    ...
    #[cfg(feature = "http_client")]
    pub fn set_http_client(&mut self, client: crate::bash::network::HttpClient) {
        self.http_client = Some(client);
    }

    /// Get a mutable reference to the HTTP client (for setting hooks after build).
    #[cfg(feature = "http_client")]
    pub(crate) fn http_client_mut(&mut self) -> Option<&mut crate::bash::network::HttpClient> {
    ...
    #[cfg(feature = "git")]
    pub fn set_git_client(&mut self, client: crate::bash::builtins::git::GitClient) {
    ...
    #[cfg(feature = "ssh")]
    pub fn set_ssh_client(&mut self, client: crate::bash::builtins::ssh::SshClient) {
            ...
            match command {
                ...
                Command::Compound(compound, redirects) => {
                    ...
                    let stdin = match self.process_input_redirections(None, redirects).await {
                        Ok(s) => s,
                        Err(crate::bash::error::Error::CommandFailure(msg)) => {
            ...
            match args.len() {
                ...
                2 => {
                    ...
                    let resolve = |p: &str| -> std::path::PathBuf {
                        ...
                        crate::bash::fs::normalize_path(&joined)
                    };
                    match args[0].as_str() {
                        "-z" => args[1].is_empty(),
                        "-n" => !args[1].is_empty(),
                ...
                3 => {
                    ...
                    match args[1].as_str() {
                        ...
                        "-ef" => {
                            let lp = crate::bash::builtins::resolve_path(
                                &std::path::PathBuf::from("/"),
                                &args[0],
                            );
                            let rp = crate::bash::builtins::resolve_path(
                                &std::path::PathBuf::from("/"),
                                &args[2],
                            );
                            lp == rp
    ...
    async fn execute_case(&mut self, case_cmd: &CaseCommand) -> Result<ExecResult> {
        use crate::bash::parser::CaseTerminator;
...
impl Interpreter {
    ...
    async fn try_alias_expansion(
        ...
        let result = match parser.parse() {
            Ok(s) => {
                ...
                if let Err(e) = crate::bash::parser::validate_budget(&s, &self.limits) {
                    Ok(ExecResult::err(
        ...
        Box::pin(async move {
            ...
            if name.is_empty() {
                ...
                return Ok(ExecResult {
                    ...
                    stderr: String::new(),
                    exit_code,
                    control_flow: crate::bash::interpreter::ControlFlow::None,
                    ..Default::default()
                });
            }
    ...
    fn execute_dispatched_command<'a>(
        ...
        Box::pin(async move {
            ...
            let trace_start = if self.trace.mode() != crate::bash::trace::TraceMode::Off {
                self.trace
    ...
    fn ensure_persistent_fd_capacity(&self, fd: i32) -> Result<()> {
        if fd < 0 {
            return Err(crate::bash::error::Error::Execution(format!(
        ...
        if open_fds.len() >= self.limits.max_file_descriptors {
            return Err(crate::bash::limits::LimitExceeded::MaxFileDescriptors(
    ...
    fn execute_builtin_arc<'a>(
        ...
        Box::pin(async move {
            ...
            let args = if !self.hooks.before_tool.is_empty() {
                let event = crate::bash::hooks::ToolEvent {
                    name: name.to_string(),
                    args: args.to_vec(),
                };
    ...
    fn apply_after_tool(&self, name: &str, result: ExecResult) -> ExecResult {
        ...
        let event = crate::bash::hooks::ToolResult {
            name: name.to_string(),
    ...
    /// Sorted names of all dispatchable builtins (registered + special + host
    /// registry). See [`crate::bash::Bash::builtin_names`].
    pub(crate) fn builtin_names(&self) -> Vec<String> {
    ...
    async fn execute_source(
        ...
        let script = match self.parse_embedded_script(&content).await {
            Ok(script) => script,
            Err(crate::bash::error::Error::Parse { message, .. }) => {
                return Ok(ExecResult::err(
        ...
        self.counters.push_function(&self.limits).map_err(|_| {
            crate::bash::error::Error::Execution(format!(
    ...
    async fn parse_embedded_script(&self, input: &str) -> Result<Script> {
        if input.len() > self.limits.max_input_bytes {
            return Err(crate::bash::error::Error::ResourceLimit(
                crate::bash::limits::LimitExceeded::InputTooLarge(
                    input.len(),
                    self.limits.max_input_bytes,
                ),
            ));
        ...
        #[cfg(not(target_family = "wasm"))]
        {
            ...
            match parse_result {
                Ok(Ok(result)) => result,
                Ok(Err(join_error)) => Err(crate::bash::error::Error::parse(format!(
                    "parser task failed: {}",
                    join_error
                ))),
                Err(_) => Err(crate::bash::error::Error::ResourceLimit(
                    crate::bash::limits::LimitExceeded::ParserTimeout(timeout),
                )),
            }
        }
    }
...
mod tests {
    ...
    fn test_parse_timeout_duration_subsecond() {
        use crate::bash::builtins::timeout::parse_duration;
    ...
    async fn test_allexport_respects_env_memory_limits() {
        ...
        let memory_limits = crate::bash::limits::MemoryLimits::new().max_variable_count(5);
    ...
    async fn test_dollar_dollar_no_host_pid_leak() {
        let mut bash = crate::bash::Bash::new();
...
cat /tmp/test_fd_exec_public.txt"#,
    ...
    fn test_restore_validation_rejects_oversized_dir_stack_entry() {
        ...
        state.dir_stack = vec![format!(
            "/{}",
            "a".repeat(crate::bash::builtins::limits::DIRSTACK_MAX_ENTRY_BYTES)
        )];
